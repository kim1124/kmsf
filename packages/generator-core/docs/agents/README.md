# @kmsf/generator-core Agent Knowledge Map

이 디렉터리는 `@kmsf/generator-core` 패키지의 에이전트 하네스 문서를 중앙 관리한다.

## Domain Map

- `root/`: package contract, exports, build, dependency policy
...
- 검증 실패, 생략, sandbox 제한은 `packages/generator-core/reports/YYYY-MM-DD.md`에 남긴다.
